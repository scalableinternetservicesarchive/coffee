    ...
    <>
      ...
      <BodyText>
        <ul className="pl4">
          ...
          <li>
            Must use the class project framework located <Link href="https://github.com/rothfels/coffee">here</Link>
          </li>
            ...
            checklistFull={[
              {
                ...
                href: 'https://github.com/rothfels/coffee#quickstart',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/rothfels/coffee#run-react-storybook',
              },
            ]}
          />
          <Sprint
