...
git clone https://github.com/rothfels/coffee.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/coffee/$SLUG/g" **/*.tf
sed -i.bak "s/coffee/$SLUG/g" **/*.ts
sed -i.bak "s/coffee/$SLUG/g" **/*.yml
sed -i.bak "s/coffee/$SLUG/g" **/*.sh
sed -i.bak "s/coffee/$SLUG/g" **/*.json
rm -rf **/*.bak
